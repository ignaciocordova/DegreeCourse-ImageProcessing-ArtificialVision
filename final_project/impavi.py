...
There are more complex algorithms like Floyd-Steinbeirg (FS) algorithm for error compensation 
and the implementation of a Kirsch Compass filter. 

If the module is useful to you feel free to 
share it citing "Ignacio Cordova Pou; https://github.com/ignaciocordova"
"""
